...
1. Burn and load 1873.cpu-u25 into Main board's Z80 CPU
2. Burn and load 1848.prom-u1 through 1870.prom-u23 into ROM board  _Note: Only those with a recent date are actually required_
