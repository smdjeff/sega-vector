...
#define PLANET_VALUE_MAX  99
#define MAX_FLEETS        (NUM_PLANETS+3)  // headroom for player and AI fleets in flight at once
...
typedef enum {
   ...
   // add new speech phrases here as speech/*.wav files are recorded
} phrase_t;
